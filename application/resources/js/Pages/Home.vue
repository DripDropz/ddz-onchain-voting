                ...
                <div class="flex flex-col justify-center h-full gap-4 p-8 lg:p-16 items-center lg:w-1/2 ">
                    <div class="flex flex-col gap-y-8">
                        <div
                            ...
                            <img :src="isDarkMode ? logo_dark : logo_light" class="h-20 mb-2" alt="DripDropz"  />
                            <span class="block text-4xl sm:text-7xl xl:text-8xl">
                                On-Chain Voting
                            </span> <span class="relative text-sky-400 whitespace-nowrap">
                        ...
                        <div class="text-lg tracking-tight lg:max-w-2xl xl:text-xl text-slate-700 dark:text-slate-300">
                            <p>
                                Easy, secure, and universally accessible on-chain voting with a simple transaction.
                            </p>
                        </div>
                        <div class="flex items-start w-full gap-6">
                            <Link :href="route('ballots.index')"
                                  class="inline-flex items-center gap-x-2 rounded-md bg-white dark:bg-transparent px-2 py-2.5  font-semibold text-sky-400 shadow-sm hover:bg-sky-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 border border-sky-400">
                                Open Ballots
                            </Link>
<!--                            <a href="#"
...
<!--                <div class="lg:w-1/2 h-full bg-center"
                     :style="{ backgroundImage: 'url(' + props.voteSplashImg + ')' }"></div>-->
            </div>
